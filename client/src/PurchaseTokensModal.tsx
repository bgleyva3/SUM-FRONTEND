...
const PurchaseTokensModal: React.FC<PurchaseTokensModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[9999]" onClick={onClose}>
      <div 
        className="w-full max-w-md mx-4 bg-gray-800 rounded-lg shadow-xl max-h-[calc(100vh-40px)] flex flex-col" 
      ...
      >
        <div className="p-6 overflow-y-auto">
          ...
          <button className="flex items-center justify-center gap-2 w-full py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-medium transition-colors">
            <CreditCard size={18} />
            Proceed to Payment
          </button>
